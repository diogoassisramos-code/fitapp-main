...
export const planos: Plano[] = [
  {
    ...
    descricao:
      "Acompanhamento completo: treino e dieta personalizados, check-in semanal com fotos.",
    tipoCobranca: "recorrente",
    modalidade: "online",
    prazoEntrega: { valor: 2, unidade: "dias_uteis" },
    incluso: { treino: true, dieta: true, protocolos: true, checkin: true },
    preco: 199,
  ...
  },
  {
    ...
    incluso: { treino: true, dieta: true, protocolos: false, checkin: true },
    preco: 1290,
    formasPagamento: ["cartao", "pix"],
    parcelamentoMax: 12,
    solicitarDocumentos: true,
  ...
  },
  {
    ...
    incluso: { treino: false, dieta: true, protocolos: false, checkin: false },
    preco: 180,
    formasPagamento: ["cartao", "pix"],
    parcelamentoMax: 3,
